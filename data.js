  ...
  matches: [
    {
      ...
      note: "【胜负关系:主=阿尔及利亚小胜/次=平·双双0分生死战】阿ML约-167(~63%)、平、约+475=中盘偏阿(非深盘)。【画像】阿尔及利亚=能控球造机会的中游(非鱼腩·R1对阿根廷半场控球占优、被梅西个人能力点杀非崩盘)但转化差;近19场仅负2、近5场4零封=防守硬;⚠️马赫雷斯替补=创造力变量。约旦=会漏球(失3给奥地利)+有韧性能进球的首秀队(非鱼腩·亚洲杯亚军曾淘汰韩国·奥尔万第二出口·别按'掐塔马里=零封'打)。【⑥维】阿0-3阿根廷(能造机会·达预期competitive·0) vs 约1-3奥地利(漏防但咬到76'·达预期0)→net≈0、回盘口偏阿。【checklist#5】约旦弱势方不败live、必须赢会压上→平是强次选。主2-1阿(质量+控球造机会破约漏防、约旦韧性咬1)、次1-0(阿近5场4零封·转化差小胜)。The One Risk=约旦务实铁桶+必须赢压上+奥尔万第二出口→1-1平甚至约旦偷胜(韧性);或阿尔及利亚转化差(马赫雷斯替补)闷成1-0。临场资金涌约/退阿→把平扶正为主。"
    },
    {
      ...
      note: "【胜负关系:主=挪威小胜/次=平·浅盘对攻好戏】挪+130(~43%)、平+240(27%)、塞+210(30%)=浅盘略偏挪(Opta挪45%/塞30%·非深盘=可信、平live)。【画像】挪威=高空型(哈兰德双响+厄德高角球·进球全来自crosses/定位球)·防线一般遇对攻会丢球;塞内加尔=能咬强队上半场的硬中游(R1上半场反击咬法·杰克逊中柱)但锋线转化差(该进没进)、遇天赋档防线会塌。⚠️挪威高空杀招对塞内加尔(库利巴利身体强·非防空弱铁桶)要打折、不像虐伊拉克。【⑥维】挪4-1伊拉克(高空虐防空弱铁桶·信息量打折) vs 塞1-3法国(上半场competitive·下半场被天赋碾)→两中上对攻、净胜小。【checklist#2】两队防线都会丢→别押大、2-1/1-1档;#5浅盘+塞有质量=平是强次选。主2-1挪(哈兰德高空破+塞咬1·挪防漏被反咬)、次1-1(浅盘平live·塞身体冲击咬住)。The One Risk=塞内加尔这次把握住机会(R1中柱/错失)×哈兰德被库利巴利锁死→塞偷胜或1-1;浅盘任何结果live。"
    },
    {
      ...
      note: "【胜负关系:主=法国大胜/次=法国大胜·⚡checklist#9硬化首次实战·坚决押大】法ML约-1200(~90%)、平+900、伊+3300(3%)=🚨深盘大热。【⚡#9前置裁决=本场关键】伊拉克=【会漏鱼腩】:R1失4给挪威、防空弱坐实(被哈兰德抢点头球+厄斯蒂高头球)、门将哈桑=负资产(42'重大回传失误)→**深盘大热=确认不是反指、控得住≠攻得破不适用、强制押over**(区别于西班牙场=沙特门神真铁桶才fade)。【画像】法国=天赋碾压档·非便秘型·姆巴佩单核发动机(R1梅开二度+30码世界波·下半场效率极高)·冲纪录(14球·2球追梅西/克洛泽·anytime-200);伊拉克防空软肋=定位球/高空提款机。【⑥维】法3-1塞(下半场火力全开) vs 伊1-4挪(防空崩)→net强lean法、与盘口同向=胜负高置信、焦点是净胜球。主3-0法(姆巴佩+登贝莱/奥利塞+定位球轰软防空)、次4-1法(over·伊有高空一瞬侯赛因型咬1)。⚠️双锚强制跨线、坚决不学西0-0那样fade。The One Risk=法国提前轮换姆巴佩/松懈+伊拉克摆纯铁桶死守→闷成2-0;临场盯姆巴佩是否首发(德尚保人则下调)。"
    },
    {
      ...
      note: "【胜负关系:主=阿根廷胜/次=阿根廷胜·别下修·净胜球别压小】阿ML约-185(~65%)、平+310(24%)、奥+550(14%)=中盘偏阿(非深盘)。【画像·关键】阿根廷=天赋碾压档·非便秘型·梅西单核carry(R1帽子戏法·低xG强行破)·零封能力真实(近5场4零封+R1 3-0);⚠️R1阿阿我把盘口锚2-0下修1-0=踩坑→**天赋碾压档信盘口锚、遇对手别下修、净胜球别压小**。梅西冲克洛泽纪录(再1球破世界杯16球纪录·动机拉满)。奥地利=高压能赢中下游但攻坚钝(R1运动战只进1·靠约旦乌龙+点球)+防守会漏(中下游约旦都进1)、别押其大胜/零封。【⑥维】阿3-0阿尔及利亚(梅西帽子·零封·超预期+1) vs 奥3-1约旦(高压赢中下游·攻坚乏力·达预期0)→net+1 lean阿。【checklist#2】奥防守会漏→阿往上够2;但奥组织+会反扑(非鱼腩)→封顶不押4。主2-0阿(零封·奥攻坚钝)、次3-1(梅西破纪录+奥纪律反击咬1)。The One Risk=阿根廷轮换(劳塔罗/J阿尔瓦雷斯争位)+提前出线松懈→1-0小胜或被奥反击咬成2-1。"
    },
    {
