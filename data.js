  ...
  matches: [
    {
      ...
      note: "【胜负关系:主=平/次=墨西哥胜】瓜达拉哈拉Akron·墨西哥主场。墨+100/-105极浅盘(50%)、平+235(28%)、韩+310(26%)=浅盘紧局。两队均首轮全胜(墨2-0南非/韩2-1捷克)、同积3分争头名,一场平对双方出线都舒服→求稳动机强。墨主场效率型+韩单兵(孙兴慜/李刚仁)能进但防线会丢=都防守纪律的紧局。按checklist'浅盘紧局平live就敢押平'→主1-1;次2-1墨西哥(主场+东道主+2018曾2-1胜韩)。临场盘偏墨则把2-1扶正为主。"
    },
    {
      ...
      note: "【胜负关系:加拿大胜】温哥华BC Place·加拿大主场。加-340/-370(77%)、平+495(16%)、卡塔尔+1100(8%)=中深盘偏加+主场。加拿大FIFA30>卡塔尔56、主场+进攻威胁(乔纳森·戴维·戴维斯存疑);卡塔尔锋无力(3.5)摆大巴、创造少、靠94'乌龙抢分。加拿大慢热是变量但主场主导。主2-0(主场破摆大巴)/次1-0(慢热+卡铁桶frustrate)。尾部1-1(加慢热被卡偷)。非传控碾压(加高位逼抢)+卡非顶级铁桶→不强触发控攻不破。"
    },
    {
      ...
      note: "【胜负关系:主=瑞士胜/次=平】SoFi(中立)。瑞-175(61%)、平24%、波黑16%=中浅盘偏瑞士。瑞士实力高一档但⚠️首轮'控得住≠攻得破'(68%控球/xG2.27/0-1靠点球被卡塔尔94'乌龙绝平);波黑能先进球(哲科)但守不住领先(被加拿大78'扳平)。瑞士小胜但别押大胜(攻不破+波黑哲科会偷1)→主2-1瑞士;次1-1(瑞士又攻不破+波黑先进守不住=互交白卷式平)。波黑非铁桶(防线软)故瑞士能破、不押0-0。"
    },
    {
      ...
      note: "【胜负关系:捷克胜】亚特兰大室内(非高原)·A组生死战(双双0分,再输基本出局)。捷克-130浅盘小热=可信档(非深盘反指,区别于西/乌深盘打铁桶翻车)。捷克实力高一档+阵容齐整(希克53场26球+霍里/绍切克三高点·3-5-2高空/定位球/远射) vs 南非锋无力(首轮0球)+⚠️两主力中场西索勒/兹瓦内染红停赛减员(单一信源·赛前~1h再核实)。南非缺单点/爆冷基因→按checklist第5条反向不扶正其平局。Under2.5→主2-0(高空/定位球破减员防线)、次1-0(开局谨慎)、尾部2-1(捷防守软偷漏)。非高原→南非首轮体能崩劣势不重演。"
    },
    {
