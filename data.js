  ...
  matches: [
    {
      ...
      note: "亚特兰大室内(非高原)·A组生死战(双双0分,再输基本出局)。捷克-130浅盘小热=可信档(非深盘反指,区别于西/乌深盘打铁桶翻车)。捷克实力高一档+阵容齐整(希克53场26球+霍里/绍切克三高点·3-5-2高空/定位球/远射) vs 南非锋无力(首轮0球)+⚠️两主力中场西索勒/兹瓦内染红停赛减员(单一信源·赛前~1h再核实)。南非缺单点/爆冷基因→按checklist第5条反向不扶正其平局。Under2.5→主2-0(高空/定位球破减员防线)、次1-0(开局谨慎)、尾部2-1(捷防守软偷漏)。非高原→南非首轮体能崩劣势不重演。"
    },
    {
    ...
    },
    {
      ...
      note: "【L组·方向命中(英胜)·比分大幅低估·净胜球低估又一例】实际4-2英格兰胜(6球混战):凯恩12'点球+42'梅开二度、贝林厄姆47'、拉什福德85';克罗地亚巴图里纳36'、穆萨45+5'(半场2-2)。⇒押1-0/次1-1判'两支好队紧局低分胶着'错得离谱——英格兰首战慢热魔咒未现(12'点球先进)、克罗地亚老辣中场没控住节奏反而被拖入对攻打成6球大战;方向对(英格兰胜)但低估4球。净胜球系统性低估再添一例,'紧局低分'对两支愿对攻的好队同样不成立。"
    },
    {
