  ...
  matches: [
    {
      ...
      note: "【胜负关系:主=哥伦比亚胜/次=哥小胜·哥胜锁出线】哥ML约-186(~64%)、平+330、刚+531=中盘偏哥·O/U2.5。【画像】哥伦比亚=多核破密防工具多元(迪亚斯/坎帕斯/J罗组织·R1 3-1乌兹·不便秘≠葡萄牙C罗单核哑火),防线会丢(被乌兹扳1);刚果金=物理硬防+反击拖住葡萄牙75%控球、维萨补时绝平=被低估硬骨头(非鱼腩),转化效率是上限。【⑥维】哥3-1乌兹(进攻成色真实·0) vs 刚1-1葡(硬防拖强队·+1)→哥多核破刚概率高于葡、但刚反击+哥防会丢=给刚进球档。【checklist】哥多核工具多→破刚硬防;#1对硬防别套大屠杀;高原DNA偏哥。主2-1哥(多核凿开+刚反击咬1)、次1-0(刚摆稳则哥低分收口)。The One Risk=刚复刻拖平葡萄牙的铁桶+反击×哥多核哑火→1-1甚至刚偷分(它已拖平葡萄牙),但哥不便秘=破刚概率高于葡。临场盯J罗/迪亚斯首发。"
    },
    {
      ...
      note: "【胜负关系:主=克罗地亚小胜/次=克胜·双双0分生死战】克ML约-185(Opta克62%)、巴+600=中浅盘偏克。【画像】巴拿马=5-4-1真铁桶(R1顶到补时才被加纳破)+进攻贫乏(迪亚斯单箭头)+守成差一口气;克罗地亚=老辣中场但R1被英带入对攻失4、莫德里奇40岁第200场体能存疑、防线会漏。【⑥维】克2-4英(防守崩·−1) vs 巴0-1加纳(铁桶但锋无力·0)→克质量更高但破铁桶效率存疑、巴守得住赢不了。【checklist#1控得住≠攻得破】克(质量进攻)打巴(真铁桶)默认收口一球分差;#5巴弱势方不败live但进攻无威胁难赢;克防会漏但巴锋线太弱难惩罚。主0-1克(质量+必须赢凿开铁桶)、次0-2克(巴守成差+克下半场拉开)。The One Risk=巴铁桶死守+莫德里奇老化+克R1便秘倾向重演→0-0闷平、巴偷分(两队同0分谁也出不了线);平是强尾部(0-0+1-1=24%)。"
    },
    {
      ...
      note: "【胜负关系:主=英格兰胜/次=英大胜·胜者锁出线】英ML约-450(~78%)、平+600、加+1300=中深盘偏英(非极端)。【画像】英格兰=愿对攻不慢热(R1 4-2克·凯恩双响12'就先进=魔咒未现)+防线会丢(被克咬2);加纳=技术流(帕特伊回归)、能守低分(1-0险胜进攻贫乏的巴拿马·非真铁桶)+塞门约/苏雷曼纳速度反击。【⑥维】英4-2克(进攻强·+1) vs 加1-0巴(技术流打弱攻铁桶·0)→net+1偏英、与盘口同向=胜负高置信。【⚡checklist#9】加纳=有组织但非真铁桶(零封的是锋无力巴拿马)→强队vs非真铁桶=次锚强制押大over、别缩2-1;英愿对攻+凯恩火热(近5场9球)+R1自己就打4球→大比分上行真实。主2-0英(控制型·破加纳低位但未必零封屠杀)、次3-1英(英攻势打穿+加速度反击咬1·大胜over)。The One Risk=加纳帕特伊回归收紧死守低分+英前30'破不开→闷成1-0;或英防再漏被加咬成2-2胶着。临场盯萨卡是否首发(预计仍替补·马杜埃凯顶)、拉什福德替补待命。"
    },
    {
      ...
      note: "【胜负关系:主=葡萄牙胜/次=葡大胜·葡须赢稳出线】葡ML约-550(~85%)、平+600、乌兹+1400=🚨深盘大热·O/U2.5。【⚡#9前置裁决=关键】乌兹别克斯坦=【会漏中下游】(R1失3给哥·3-4-3攻势阵非铁桶·但法伊祖拉耶夫进队史首球=有得分点)→**深盘大热=确认不是反指、强制押大、别学西班牙0-0那样fade**(区别真铁桶才收口)。【画像】葡萄牙=传控+球星但攻坚钝(R1控球75%射正1·C罗3射0正=控得住攻不破第5例·'球星单核≠破局单核'),须赢压上。【⑥维】葡1-1刚果金(对硬防便秘·−1) vs 乌兹1-3哥(会漏非铁桶·0)→换对手葡火力应回归(乌兹≠刚果金硬防)。主2-0葡(对会漏队天赋释放·under侧)、次3-1葡(乌兹咬1·over跨线)。The One Risk=C罗单核哑火×乌兹收缩→葡传控破不开闷成1-0/1-1=首战刚果金剧本复刻。临场盯C罗是否首发/B费莱奥状态。"
    },
    {
